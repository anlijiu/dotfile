...
if has("gui_running")
    ...
    if v:version >= 703
        hi Conceal      gui=NONE      guifg=#303030   guibg=NONE
    ...
    if v:version >= 703
        exec "hi Conceal      cterm=NONE      ctermfg=" . <SID>X(81) . " ctermbg=" . "NONE"
        exec "hi ColorColumn  cterm=NONE      ctermbg=" . <SID>X(81)
    endif
"    exec "hi CursorLine   cterm=NONE ctermbg=238 guibg=darkgrey"
endif
